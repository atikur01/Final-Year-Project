...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 01, 2024 at 07:38 AM
...
CREATE TABLE `company_details` (
  ...
  `company_background` text COLLATE utf8mb4_general_ci,
  `services` text COLLATE utf8mb4_general_ci,
  `expertise` text COLLATE utf8mb4_general_ci,
  `img_logo_path` text COLLATE utf8mb4_general_ci
...
CREATE TABLE `job_applications` (
  ...
  `applicant_email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `job_postings` (
  ...
  `jobType` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jobDescription` text COLLATE utf8mb4_general_ci,
  `responsibilities` text COLLATE utf8mb4_general_ci,
  `eduExperience` text COLLATE utf8mb4_general_ci,
  `otherBenefits` text COLLATE utf8mb4_general_ci,
  `publishedOn` date DEFAULT NULL,
  `vacancy` int DEFAULT NULL,
  `experience` int DEFAULT NULL,
  `gender` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jobSalary` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `deadline` date DEFAULT NULL,
  `job_post_status` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Data Analyst', 4, '2024-04-24 14:51:03'),
(2, 'Software Developer', 44, '2024-04-24 15:16:22'),
(3, 'Network Engineer', 23, '2024-04-24 15:19:56');
...
--
ALTER TABLE `job_postings`
  MODIFY `job_post_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `job_applications`
  ADD CONSTRAINT `job_applications_ibfk_1` FOREIGN KEY (`job_id`) REFERENCES `job_postings` (`job_post_id`);
