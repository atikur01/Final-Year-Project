...
<div style="padding-left:7%" class="container mt-5">
    ...
    <div class="form-group">
        ...
        <label for="photo">Choose Logo : </label>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="companyType" name="companyType" value="<?php echo $row['company_type']; ?>" required>
</div>
...
<div class="form-group">
    ...
    <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $row['phone_no']; ?>" required>
</div>
...
<div class="form-group">
    ...
    <textarea class="form-control" id="companyBackground" name="companyBackground" rows="3" required><?php echo $row['company_background']; ?></textarea>
</div>

<!-- Services -->
<div class="form-group">
    <label for="services">Services:</label>
    <textarea class="form-control" id="services" name="services" rows="3" required><?php echo $row['services']; ?></textarea>
</div>

<!-- Expertise -->
<div class="form-group">
    <label for="expertise">Expertise:</label>
    <textarea class="form-control" id="expertise" name="expertise" rows="3" required><?php echo $row['expertise']; ?></textarea>
</div>
