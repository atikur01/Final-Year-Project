                        ...
                        <tbody style="text-align: center;" >
                           ...
                           <?php // Loop through the fetched data and display it in the table
                              while ($row = $getalljobresult->fetch_assoc()) {
                                  ...
                                  echo "<td>" .   '<a href="view-applicants.php?job_post_id=' . htmlspecialchars($row["job_post_id"], ENT_QUOTES, 'UTF-8') . '" target="_blank" class="btn btn-success" role="button">View Applicants</a>' . "</td>";
